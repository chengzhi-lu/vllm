...
def get_requests(tokenizer) -> Dict[int, Tuple[str, SamplingParams, int]]:
    init_seq = {}
    prompt_token_ids = tokenizer("Hello, how are you?").input_ids
...
def create_init_prompts(
    ...
    if prefill_mode == "vertical":
        ...
        selected_seqs = [seqs[next(iter(seqs))]]
